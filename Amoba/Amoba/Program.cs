...
namespace Amoba
{
    ...
    class Program
    {
        ...
        static bool test(char[,] palya)
        {
            ...
            // FERDE BEJÁRÁS
            //bal felső sarokból indul, jobb alsóba
            int ferde_talalat = 0;
            for (int i = 0; i < 3; i++)
            {
                if (palya[0, 0] != ' ')
            ...
            ferde_talalat = 0;
            //jobb felső sarokból indul, bal alsóba
            for (int i = 0; i < 3; i++)
            {
                if (palya[0, 2] != ' ')
                {
        ...
        static void Main(string[] args)
        {
            ...
            while (jatekMegy)
            {
                ...
                Console.WriteLine("\n__ " + jatekos + " köre __");
                Console.Write("\n Sor: ");
                //Hibakezelés (Ne lehessen bármilyen betűt, speciális és egyéb karaktert megadni, csak az 1,2,3 numerikus karaktereket):
                int sor = 0;
                try
                {
                ...
                if (palya[sor, oszlop] == ' ')
                {
                    ...
                    if (test(palya))
                    {
                        Console.WriteLine(jatekos + " győzött!");
                        jatekMegy = false;
                        allas(palya);
                    }
                    else
